...
const description =
  "AI HackerDorm Sarawak is a 2-day AI hackathon by AI HackerDorm and the Swinburne Computer Science Club in Kuching, Borneo. Countdown, schedule, and event details.";
